...
subdata <- subset(data, as.character(Date) == "1/1/2007" | as.character(Date) == "2/1/2007")
...
##Build Plot 3
plot(subdata$DateTime,as.numeric(as.character(subdata$Sub_metering_1)),type = "l",ylim = c(0,25),xlab = "",ylab = "Energy sub metering")
